...
true_class = np$load(path.expand(paste0(c('~/Documents/GitHub/Discrete_VAEs/saved_data/LCA/class/', NCLASS, '_', NITEMS,'.npy'), collapse = '')))
true_probs = np$load(path.expand(paste0(c('~/Documents/GitHub/Discrete_VAEs/saved_data/LCA/itempars/', NCLASS, '_', NITEMS,'.npy'), collapse = '')))
